...
![Pat from Product on Slack: Hey! super small thing, can we add notifications to the app? Should be quick](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/intro.png)
...
![Iceberg meme: above the water, Pat says it's a small change; below the water, a new SMS vendor, an append-only audit log, AI by Friday, an enterprise demo tomorrow, and "actually, can we go back to email?"](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/intro_iceberg.png)
...
![Pat on Slack: QA says they can't test the new email template without spinning up the entire notifier, can we fix by EOD?](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/s.png)
...
![Reject-and-approve meme: no to emailing the whole company to test one template, yes to testing EmailChannel_v1 on its own](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/s_drake.png)
...
![Pat on Slack: BIG NEWS, customers hate email, we're pivoting to SMS, that's a one-line change right? Then: update, push notifications are the future. Then: update 2, every enterprise lives in Slack](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/o.png)
...
![Expanding brain meme: Email, SMS, Push notifications, Slack, and at the most enlightened level, zero edits to Notifier_v4](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/o_expanding_brain.png)
...
![Friday, 4:47pm, Pat on Slack: Finance found a cheaper SMS vendor, TextBlaster! Already signed the contract, we go live Monday](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/d.png)
...
![This is fine meme: Monday, 9:01am, a developer at a desk surrounded by flames under an AttributeError saying TextBlasterSmsChannel_v1 has no attribute connect](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/d_this_is_fine.png)
...
![Pat on Slack: The board asked about our AI strategy, can notifications be AI-powered by Friday? Just make them pop. Then on Monday: Compliance is asking why the audit log is empty, did something change?](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/l.png)
...
![Two buttons meme: a red button labelled keep the compliance contract and another labelled ship AI by Friday, above a sweating face captioned me, Thursday night](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/l_two_buttons.png)
...
![Pat on Slack: HUGE enterprise demo tomorrow, they want the legacy email plan, the compliance plan, and the AI plan side by side, one campaign runner for all three, easy right?](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/i.png)
...
![They're the same picture meme: compliance asks for the differences between two framed empty lists, the legacy plan's get_audit_log and get_audit_log with the audit log off; they're the same picture](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/i_same_picture.png)
...
![Pat on Slack: So, customers actually kind of liked email, can we go back? You reply: sure, with a one-line diff in notifications/wiring.py swapping the Slack channel for the email channel](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/slack/outro.png)
...
![Stonks meme: Pat asks can we go back to email, I change one line in wiring.py, and a rising green chart says stonks](https://raw.githubusercontent.com/rawmarshmellows/surviving-pat-from-product-with-solid/master/images/memes/outro_stonks.png)
