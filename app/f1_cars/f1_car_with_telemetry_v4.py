...
from .interface import NonHybridAccelerableInterface, TelemetryInterface, StartableInterface
from ..fuel_tank.fuel import Fuel

class F1CarWithTelemetry_v4(NonHybridAccelerableInterface, TelemetryInterface, StartableInterface):
