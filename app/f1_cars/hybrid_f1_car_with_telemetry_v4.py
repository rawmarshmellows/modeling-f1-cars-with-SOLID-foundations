...
from .interface import HybridAccelerableInterface, TelemetryInterface, StartableInterface
...
class HybridF1CarWithTelemetry_v4(HybridAccelerableInterface, TelemetryInterface, StartableInterface):
